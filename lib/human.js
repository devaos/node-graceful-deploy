...
human.prototype.processMessageFromSkinjob = function(msg, handle) {
  ...
  if(!msg || !msg.port)
    return core.error('unexpected message from deploy process')
